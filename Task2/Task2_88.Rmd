...
## calculate correlations and magnitude against store 86 using total sales and number of customers.
```{r}
trial_store <- 88
...
The results show that the trial in store 88 is significantly different to its control store in the trial period in two of the three trial months.
